...
const sectionIconMuted = 'text-indigo-600 dark:text-indigo-400'
        ...
        <div className={cardShell}>
          <div className="border-b border-zinc-200/80 bg-zinc-50/60 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900/35">
            ...
            <div className="mt-3">
              <Badge
                ...
                className={cn(
                  badgeTint,
                  'inline-flex gap-1.5 px-2.5 py-1 text-sm font-medium',
          ...
          <dl className="divide-y divide-zinc-100 dark:divide-zinc-800">
            <div className="flex gap-3 px-4 py-3">
              <Hash className="mt-0.5 h-4 w-4 shrink-0 text-zinc-400 dark:text-zinc-500" strokeWidth={1.5} />
            ...
            <div className="flex gap-3 px-4 py-3">
              <Calendar className="mt-0.5 h-4 w-4 shrink-0 text-zinc-400 dark:text-zinc-500" strokeWidth={1.5} />
            ...
            <div className="flex gap-3 px-4 py-3">
              <Clock className="mt-0.5 h-4 w-4 shrink-0 text-zinc-400 dark:text-zinc-500" strokeWidth={1.5} />
              <div className="min-w-0 flex-1">
        ...
        <div className={cardShell}>
          <div className="border-b border-zinc-200/80 bg-zinc-50/50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900/30">
            ...
            <p className="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">
              Cliente, mercancía de entrada y salida del proceso.
            </p>
          </div>
          ...
          <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
            ...
            <section className="px-4 py-5 md:px-6">
              <div className="mb-4 rounded-xl bg-rose-50/70 px-3 py-2.5 dark:bg-rose-950/25">
                <div className="flex items-center gap-2">
                  <Package className="h-4 w-4 shrink-0 text-rose-700 dark:text-rose-400" strokeWidth={1.5} />
                  <div>
                    <h3 className="text-xs font-semibold uppercase tracking-wide text-zinc-800 dark:text-zinc-200">
                      Mercancía recibida (defectuosa)
                    </h3>
                    <p className="text-[11px] text-zinc-600 dark:text-zinc-400">Producto ingresado al proceso de garantía</p>
                  </div>
                </div>
              </div>
              <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div className="sm:col-span-2">
                  ...
                  <dd className="mt-2 rounded-xl border border-zinc-200/90 bg-zinc-50/90 px-3 py-2.5 text-sm leading-relaxed text-zinc-900 dark:border-zinc-700 dark:bg-zinc-950/50 dark:text-zinc-100">
                    {warranty.reason || '—'}
                  </dd>
                </div>
              </dl>
            ...
            <section className="px-4 py-5 md:px-6">
              <div className="mb-4 rounded-xl bg-emerald-50/70 px-3 py-2.5 dark:bg-emerald-950/20">
                <div className="flex items-center gap-2">
                  <Package className="h-4 w-4 shrink-0 text-emerald-700 dark:text-emerald-400" strokeWidth={1.5} />
                  <div>
                    <h3 className="text-xs font-semibold uppercase tracking-wide text-zinc-800 dark:text-zinc-200">
                      Resolución — mercancía entregada
                    </h3>
                    <p className="text-[11px] text-zinc-600 dark:text-zinc-400">Reemplazo o cierre del caso</p>
                  </div>
                </div>
              </div>
              ...
              {warranty.productDeliveredName ? (
                ...
                <div className="rounded-xl border border-dashed border-zinc-200 bg-zinc-50/60 px-4 py-8 text-center dark:border-zinc-700 dark:bg-zinc-950/30">
