          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isDisabled &&
                  isSelectedDay &&
                  'z-[1] bg-emerald-500 font-semibold text-white hover:bg-emerald-600 focus-visible:bg-emerald-600 dark:bg-emerald-600 dark:text-white dark:hover:bg-emerald-500',
                !isDisabled &&
                  !isSelectedDay &&
                  isCurrentMonth &&
                  'text-zinc-900 hover:bg-emerald-50 dark:text-zinc-100 dark:hover:bg-emerald-950/35',
          ...
          <button
            ...
            className={cn(
              ...
              isDateDisabled(new Date())
                ...
                : 'bg-emerald-50 font-semibold text-emerald-800 hover:bg-emerald-100 dark:bg-emerald-950/50 dark:text-emerald-200 dark:hover:bg-emerald-900/40'
            )}
          >
            Hoy
          </button>
