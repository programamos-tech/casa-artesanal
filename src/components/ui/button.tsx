  ...
  return (
    <button
      className={cn(
        ...
        variant === 'outline' &&
          'rounded-lg border border-zinc-300 bg-white text-zinc-800 shadow-none hover:bg-zinc-50 dark:border-emerald-700/70 dark:bg-zinc-900/65 dark:text-emerald-200 dark:hover:border-emerald-600/80 dark:hover:bg-zinc-800',
        variant === 'secondary' &&
          'rounded-lg border border-transparent bg-zinc-200/90 text-zinc-900 shadow-none hover:bg-zinc-300/80 dark:bg-emerald-900/30 dark:text-emerald-200 dark:hover:bg-emerald-900/45',
        variant === 'ghost' &&
          'rounded-lg border border-transparent text-zinc-700 shadow-none hover:bg-zinc-100 dark:text-emerald-200 dark:hover:bg-emerald-900/30',
        variant === 'link' &&
          'rounded-md text-zinc-600 shadow-none underline-offset-4 hover:underline dark:text-emerald-300',
        {
