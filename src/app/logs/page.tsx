...
export default function LogsPage() {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-b from-indigo-50/60 via-white to-violet-50/40 py-4 dark:from-indigo-950/30 dark:via-zinc-950 dark:to-violet-950/20 max-xl:pb-1 md:py-6">
